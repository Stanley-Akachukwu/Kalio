...
public partial class CreateWeatherCommandValidator : AbstractValidator<CreateWeatherCommand>
{

    private readonly KalioDbContext _dbContext;
    public CreateWeatherCommandValidator(KalioDbContext dbContext)
    {
